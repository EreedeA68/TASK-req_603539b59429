...
CREATE TABLE IF NOT EXISTS users (
    ...
    role ENUM('SHOPPER','STAFF','ADMIN','READ_ONLY') NOT NULL DEFAULT 'SHOPPER',
...
CREATE TABLE IF NOT EXISTS orders (
    ...
    status ENUM('PENDING','PENDING_AT_REGISTER','COMPLETED','REFUNDED','READY_FOR_PICKUP') NOT NULL DEFAULT 'PENDING',
...
CREATE TABLE IF NOT EXISTS behavior_events (
    ...
    user_id BIGINT NOT NULL,
    product_id BIGINT NOT NULL,
    event_type ENUM('VIEW','FAVORITE','ADD_TO_CART','PURCHASE','RATING') NOT NULL,
    created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE,
    FOREIGN KEY (product_id) REFERENCES products(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS payment_transactions (
    ...
    status ENUM('SUCCESS','FAILED','REFUNDED','DEPOSIT','PRE_AUTHORIZED') NOT NULL DEFAULT 'SUCCESS',
    idempotency_key VARCHAR(255) NOT NULL UNIQUE,
